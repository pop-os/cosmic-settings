...
vpn-error = Eroare VPN
    ...
    .with-password = Eșec la setarea VPN { $field ->
        *[username] nume utilizator
        [password] parolă
...
default = Implicit
magnifier = Lupă
    .controls = Sau utilizează aceste comenzi rapide: { $zoom_in ->
             [zero] {""}
            *[other] {""}
...
mirroring = Oglindire
    ...
    .project-count = Proiectează către alt(e) { $count } { $count ->
        [1] ecran 
        *[other] ecrane 
    }
...
battery = Baterie
  ...
  .and = și
  .remaining-time = { $time } până când { $action ->
...
migrate-workspace = Migrează spațiul de lucru la ieșirea { $direction ->
  *[down] jos
  [left] stânga
  [right] dreapta
  [up] sus
...
nav-shortcuts = Navigare
  ...
  .focus = Focalizează fereastra { $direction ->
    *[down] jos
    [in] în
    [left] stânga
    [out] afară
  ...
  .output = Comută la ieșirea { $direction ->
    *[down] jos
    [left] stânga
    [right] dreapta
    [up] sus
...
move-windows = Mută ferestrele 
  .direction = Mută fereastra în { $direction ->
        *[down] jos
        [left] stânga
        [right] dreapta
        [up] sus
  }
  .display = Mută fereastra la un monitor în { $direction ->
        *[down] jos
        [left] stânga
        [right] dreapta
        [up] sus
  }
  .workspace = Mută fereastra la un spațiu de lucru în { $direction ->
        *[below] sub
        [left] stânga
        [right] dreapta
        [above] deasupra
