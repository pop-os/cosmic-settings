...
sound-applications = Приложения
    .desc = Громкость приложений и настройки
    .none = Нет приложений, использующих звук
...
accessibility = Специальные возможности
    ...
    .shake-cursor = Увеличивать указатель при встряхивании
    .shake-cursor-desc = Быстро встряхните мышь, чтобы временно увеличить указатель
hearing = Слух
