...
dialog = Diálogo
    .title = Manter estas Configurações de Ecrã?
    .keep-changes = Manter Alterações
    .change-prompt = As alterações nas definições serão automáticamente revertidas em { $time } segundos.
...
keyboard-typing-assist = Escrita
    .repeat-rate = Frequência de repetição
    .repeat-delay = Frequência de atraso
...
migrate-workspace-next = Migrar área de trabalho para a próxima saída
migrate-workspace = Migrar área de trabalho para a saída { $direction ->
    *[down] de baixo
    [left] da esquerda
    [right] da direita
    [up] de cima
...
nav-shortcuts = Navegação
    ...
    .next-output = Focar na próxima saída
    .last-workspace = Focar na última área de trabalho
    .prev-workspace = Focar na área de trabalho anterior
    .next-workspace = Focar na próxima área de trabalho
    .focus = Focar na janela { $direction ->
        *[down] em baixo
        [in] de dentro
        [left] da esquerda
        [out] de fora
    ...
    .output = Trocar para a saída { $direction ->
        *[down] de baixo
        [left] da esquerda
        [right] da direita
        [up] de cima
...
manage-windows = Gerir janelas
    ...
    .toggle-sticky = Tornar janela pegajosa (sticky)
...
move-windows = Mover Janelas
    ...
    .display = Mover janela um monitor { $direction ->
        *[down] para baixo
        [left] para a esquerda
        [right] para a direita
        [up] para cima
    }
    .workspace = Mover janela uma área de trabalho { $direction ->
        *[below] para baixo
        [left] para a esquerda
        [right] para a direita
        [above] para cima
    ...
    .next-display = Mover janela para o próximo ecrã
...
system-shortcut = Sistema
    ...
    .volume-lower = Diminuir o volume da saída do audio
    .volume-raise = Aumentar o volume da saída do audio
    .web-browser = Abre o navegador de Internet
...
time-date = Data e Hora
    ...
    .auto-ntp = A data e a hora serão actualizadas automaticamente quando o fuso horário for definido.
