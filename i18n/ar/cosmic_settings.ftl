...
enable-export = طبِّق هذه السمة على تطبيقات جنوم.
    .desc = لا تدعم كل عُدَد الأدوات التبديل الآلي. بقية التطبيقات غير المرتبطة بِكُوزمِك ستحتاج لإعادة التشغيل بعد تغيير السمة.
...
display = الشاشات
    .desc = أدر الشاشات، وتبديل الرسوميات، والإضاءة الليلية
