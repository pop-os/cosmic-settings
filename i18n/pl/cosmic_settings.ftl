...
rgb = RGB
window-hint-accent = Kolor podświetlenia aktywnego okna
window-hint-accent-toggle = Użycie koloru akcentu motywu jako podświetlenia aktywnego okna
...
control-tint = Sterowanie odcieniami komponentów
    .desc = Używany do tła standardowych guzików, wprowadzania wyszukiwania, wprowadzania tekstowego i podobnych komponentów.

frosted = Efekt zmrożonego szkła na interfejsie systemowym
    .desc = Nakłada efekt rozmycia na panel, dok, aplety, program uruchamiający oraz bibliotekę aplikacji.

text-tint = Odcień tekstu interfejsu
    .desc = Kolor używany do uzyskania odcieniu tektu interfejsu, który ma wystarczający kontrast na różnych powierzchniach.
...
window-management = Zarządzanie Oknami
    .active-hint = Rozmiar podkreślenia aktywnego okna
    .gaps = Przerwy pomiędzy kaflami okien

## Desktop: Notifications

notifications = Powiadomienia
    .desc = Nie przeszkadzać, powiadomienia ekranu blokady oraz ustawienia na konkretną aplikację.

## Desktop: Options

desktop-panel-options = Pulpit i Panel
    .desc = Akcje Klawisza Super, gorący narożnik, opcje sterowania oknem.
...
hot-corner = Gorące Rogi
    .top-left-corner = Włącz Obszary Robocze w górnym lewym gorącym narożniku.
...
panel-behavior-and-position = Zachowanie i Pozycja
...
workspaces-multi-behavior = Zachowanie Przy Wielu Monitorach
...
online-accounts = Konta Online
    .desc = Dodaj konta, IMAP, SMTP, Add accounts, IMAP and SMTP, firmowe logowanie
...
users = Urzytkownicy
    .desc = Uwierzytelnienie, login i ekran blokady.
...
keyboard-sources = Żródła Wprowadzania Danych
    .desc = Żródła Wprowadzania Danych mogą być zmienione naciskając kombinację klawiszy Super i Spację. Może być to spersonalizowane w ustawieniach skrótów klawiaturowych.
...
keyboard-special-char = Wpis Znaków Specjalnych
    .alternate = Alternatywne klawisze znaówAlternate characters key
...
mouse = Myszka
    ...
    .double-click-speed = Prędkość podwójnego kliku
    .double-click-speed-desc = Ustawia to, jak szybki musi być podwójny klik, by był zarejestrowany.
