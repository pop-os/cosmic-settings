...
default = Predvolené
magnifier = Lupa
    .controls = Alebo použite tieto skratky: { $zoom_in ->
             [zero] {""}
            *[other] {""}
...
mirroring = Zrkadlenie
    ...
    .project = Projekcia na { $display ->
        [all] všetky displeje
        *[other] { $display }
    }
    .project-count = Projekcia na { $count } ďalšie { $count ->
        [one] displej
        [two] displeje
        [few] displeje
        *[other] displejov
...
migrate-workspace = Presunúť pracovný priestor na výstup { $direction ->
    *[down] dole
    [left] vľavo
    [right] vpravo
    [up] hore
...
nav-shortcuts = Navigácia
    ...
    .output = Prepínať na výstup { $direction ->
        *[down] dole
        [left] vľavo
        [right] vpravo
        [up] hore
