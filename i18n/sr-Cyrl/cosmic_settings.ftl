...
no-applets-found = Није пронађен аплет...
all = Све
...
mouse = Миш
    ...
    .double-click-speed = Брзина дуплог клика
    .double-click-speed-desc = Мења колико брзи дупли кликови морају бити да би се регистровали.
