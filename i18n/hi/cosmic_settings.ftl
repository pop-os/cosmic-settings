...
bluetooth = ब्लूटूथ
    ...
    .show-device-without-name = बिना नाम वाले उपकरण दिखाएं
...
migrate-workspace = कार्यक्षेत्र को { $direction ->
    *[down] नीचे
    [left] बायां
    [right] दायां
    [up] ऊपर
...
nav-shortcuts = नेविगेशन
    ...
    .output = आउटपुट पर स्विच करें { $direction ->
        *[down] नीचे
        [left] बायां
        [right] दायां
        [up] ऊपर
...
move-windows = विंडो को स्थानांतरित करें
    .direction = विंडो { $direction ->
        *[down] नीचे
        [left] बाएँ
        [right] दाएँ
        [up] ऊपर
    } पर ले जाएं
    .display = विंडो को एक मॉनिटर { $direction ->
        *[down] नीचे
        [left] बाएँ
        [right] दाएँ
        [up] ऊपर
    } पर ले जाएं
    .workspace = विंडो को एक कार्यक्षेत्र { $direction ->
        *[below] नीचे
        [left] बाएँ
        [right] दाएँ
        [above] ऊपर
