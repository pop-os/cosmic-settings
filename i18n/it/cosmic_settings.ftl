...
xdg-entry-mobile-comment = Banda larga mobile, SIM e profili di connessione
xdg-entry-mobile-keywords = COSMIC;Mobile;Banda larga;Cellulare;WWAN;Modem;5G;LTE;SIM;
...
remove-connection-dialog = Rimuovere il profilo di connessione?
    .mobile-description = Sarà necessario ricreare questo profilo di banda larga mobile per utilizzarlo in futuro.
...
mobile = Banda larga mobile
    ...
    .data = Dati mobili
    .default = Predefinita
    .interface = Interfaccia di rete: { $interface }
    .network-type = Tipo di rete preferito
    .network-type-unavailable = La selezione del tipo di rete non è disponibile per questo modem.
    .network-preferences = Preferenze di rete
    .network-type-applying = Applicazione…
    .network-type-failed = Il firmware del modem ha rifiutato il tipo di rete selezionato, quindi è stato rimosso dall’elenco.
    .network-automatic = Automatico (3G, 4G, 5G; preferisci 5G)
    .network-4g-5g = 4G / 5G (preferisci 5G)
    .network-5g-only = Solo 5G
    .network-3g-4g = 3G / 4G (preferisci 4G)
    .network-4g-only = Solo 4G
    .network-3g-only = Solo 3G
    .network-custom = { $allowed } (preferisci { $preferred })
    .network-bands = Bande preferite
    .network-bands-unavailable = La selezione delle bande non è disponibile per questo modem.
    .network-bands-edit = Seleziona
    .network-bands-summary = { $selected } di { $supported } bande supportate selezionate
    .network-bands-description = Seleziona le bande che il modem può usare. Almeno una banda deve restare selezionata.
    .network-bands-warning = L’applicazione del band lock può disconnettere brevemente i dati mobili.
    .network-bands-3g = Bande 3G
    .network-bands-4g = Bande 4G LTE
    .network-bands-5g = Bande 5G NR
    .network-bands-other = Altre bande
    .network-bands-apply = Applica
    .network-bands-automatic = Automatico
    .network-bands-applying = Applicazione…
    .network-bands-failed = Il modem non ha applicato le bande selezionate. Verifica che siano supportate dal firmware attuale.
    .network-details = Dettagli rete mobile
    .network-details-unavailable = I dettagli non sono al momento disponibili dal modem.
    .network-operator = Operatore
    .network-cell = Cella connessa
    .network-cell-unavailable = Le informazioni sulla cella connessa non sono disponibili.
    .network-lte-signal = Segnale 4G LTE
    .network-5g-signal = Segnale 5G NR
    .network-aggregation = Aggregazione portanti
    .network-aggregation-unavailable = Le bande aggregate non sono esposte dal driver di questo modem.
    .network-signal-guide = Guida alla qualità del segnale
    .network-signal-guide-description = RSRP: buono ≥ −90 dBm, scarso < −100 dBm · RSRQ: buono ≥ −15 dB, scarso < −20 dB · SINR: buono ≥ 13 dB, scarso < 0 dB
    .signal-excellent = Ottimo
    .signal-good = Buono
    .signal-fair = Discreto
    .signal-poor = Scarso
    .signal-very-poor = Molto scarso
    .profiles = Profili di connessione
    .remove = Rimuovi profilo
    .set-default = Imposta come predefinita
    .status-connected = Connesso a { $profile }
    .status-disconnected = Non connesso
    .adapter = Adattatore a banda larga mobile { $id }
    .connections = Connessioni a banda larga mobile
    .enable = Abilita banda larga mobile
    .enable-description = Attiva o disattiva la radio WWAN
    .no-device = Nessun dispositivo a banda larga mobile rilevato.
    .no-profiles = Nessun profilo a banda larga mobile configurato.
wifi = Wi-Fi
