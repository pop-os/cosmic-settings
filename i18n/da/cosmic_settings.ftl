...
vpn-error = VPN Fejl
    ...
    .openvpn-config-path = Ugyldig filsti til OpenVPN-konfiguration
    .openvpn-config-path-desc = Den valgte fil skal befinde sig på et lokalt filsystem.
...
enable = Enable
bluetooth = Bluetooth
    .status = Dette system er synligt som { $aliases } mens Bluetooth-indstillinger er åbne.
    .connected = Forbundet
    .connecting = Forbinder
    .disconnecting = Afbryder forbindelse
    .connect = Opret forbindelse
    .disconnect = Afbryd forbindelse
    .forget = Glem
    .dbus-error = Der opstod en fejl ved kommunikation med DBus: { $why }
...
wallpaper = Baggrund
    .change = Skift billede hver
    .fit = Tilpas baggrund
    .folder-dialog = Vælg baggrundsmappe
    .image-dialog = Vælg baggrundsbillede
    .plural = Baggrunde
    .same = Samme baggrund på alle skærme
    .slide = Diasshow
...
xdg-entry-appearance-keywords = COSMIC;Accent;Farve;Ikon;Skrifttype;Tema
xdg-entry-dock-keywords = COSMIC;Dock;Panel;Applet
xdg-entry-a11y = Tilgængelighed
xdg-entry-desktop-keywords = COSMIC;Skrivebord;
...
xdg-entry-a11y-keywords = COSMIC;Tilgængelighed;A11y;Skærm;Oplæser;Forstørrelse;Kontrast;Farve;
xdg-entry-desktop = Skrivebord
xdg-entry-date-time-keywords = COSMIC;Tid;Zone;
...
xdg-entry-input-keywords = COSMIC;Input;Tastatur;Mus;Mus;
xdg-entry-comment = Indstillingsprogram for COSMIC skrivebord
xdg-entry-applications = Applikationer
xdg-entry-default-apps-keywords = COSMIC;Standard;Program
xdg-entry-keywords = COSMIC;Indstillinger;
xdg-entry-about = Om
xdg-entry-input = Inputenheder
xdg-entry-applications-keywords = COSMIC;Standard;Program;Opstart;X11;Kompatibilitet
xdg-entry-appearance = Udseende
xdg-entry-displays-keywords = COSMIC;Skærm;
...
xdg-entry-touchpad = Pegefelt
xdg-entry-wired = Kablet
xdg-entry-startup-apps-comment = Konfigurer programmer, der kører ved login
xdg-entry-region-language = Region og sprog
xdg-entry-mouse-keywords = COSMIC;Mus;Acceleration;Rulning;
xdg-entry-notifications-keywords = COSMIC;Notifikation;Lås;
xdg-entry-startup-apps-keywords = COSMIC;Opstart;Program;
xdg-entry-keyboard-comment = Inputkilder, skift, indtastning af specialtegn og genveje
xdg-entry-wired-keywords = COSMIC;Kablet;LAN;Netværk;Forbindelse;
xdg-entry-power = Strøm og batteri
xdg-entry-mouse = Mus
xdg-entry-mouse-comment = Musehastighed, acceleration og naturlig rulning
xdg-entry-system = System og konti
xdg-entry-panel-keywords = COSMIC;Panel;Applet
xdg-entry-window-management = Vindueshåndtering
xdg-entry-time-language-comment = Administrer systemdato, tid, region og sprog
xdg-entry-x11-applications-keywords = COSMIC;X11;Program;Spil;Kompatibilitet;
xdg-entry-touchpad-keywords = COSMIC;Pegefelt;Bevægelse;
xdg-entry-time-language = Tid og sprog
xdg-entry-users = Brugere
xdg-entry-system-keywords = COSMIC;System;Info;Konti;Firmware;
xdg-entry-wireless-keywords = COSMIC;WiFi;Wi-Fi;Netværk;Forbindelse;
xdg-entry-panel = Panel
xdg-entry-notifications = Notifikationer
xdg-entry-wireless-comment = Wi-Fi-forbindelser og forbindelsesprofiler
xdg-entry-wallpaper = Baggrund
xdg-entry-network = Netværk og trådløst
xdg-entry-users-comment = Godkendelse og brugerkonti
xdg-entry-network-keywords = COSMIC;Netværk;Trådløs;WiFi;VPN;
xdg-entry-wallpaper-comment = Baggrundsbilleder, farver og diasshowindstillinger
xdg-entry-startup-apps = Opstartsprogrammer
xdg-entry-wireless = Wi-Fi
xdg-entry-workspaces-keywords = COSMIC;Arbejdsområde;Orientering;Oversigt;Skærm;
xdg-entry-system-comment = Systemoplysninger, konti og firmwareopdateringer
xdg-entry-x11-applications-comment = Skalering af X11-vinduesprogrammer, primær skærm og globale genveje
xdg-entry-region-language-comment = Formater datoer, tidspunkter og tal baseret på din region
xdg-entry-wallpaper-keywords = COSMIC;Baggrund;Baggrund;Diasshow;
xdg-entry-users-keywords = COSMIC;Bruger;Konto;
xdg-entry-vpn-keywords = COSMIC;VPN;Netværk;Forbindelse;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = COSMIC;System;Tid;Dato;Region;Sprog;
xdg-entry-notifications-comment = Forstyr ikke, låseskærmsnotifikationer og indstillinger pr. program
xdg-entry-sound-keywords = COSMIC;Lyd;Lyd;Alarm;Pipewire;
xdg-entry-power-keywords = COSMIC;Strøm;Batteri
xdg-entry-region-language-keywords = COSMIC;Region;Sprog;Dato;Format;Tid;Lokation;Lokalisering;
xdg-entry-sound-comment = Lydindstillinger for enheder, alarmer og programmer
xdg-entry-touchpad-comment = Pegefelthastighed, klikindstillinger og bevægelser
xdg-entry-keyboard-keywords = COSMIC;Tastatur;Input;Kilde;Genveje;
xdg-entry-vpn-comment = VPN-forbindelser og forbindelsesprofiler
xdg-entry-window-management-keywords = COSMIC;Vindue;Håndtering;Opdeling;Super;Tast;
xdg-entry-workspaces-comment = Arbejdsområdernes orientering, oversigt og adfærd på flere skærme
xdg-entry-network-comment = Administrer netværksforbindelser
xdg-entry-panel-comment = Primær systembjælke til menuer og applets
xdg-entry-sound = Lyd
xdg-entry-power-comment = Strømtilstande og strømspareindstillinger
xdg-entry-workspaces = Arbejdsområder
xdg-entry-x11-applications = Kompatibilitet med X11-programmer
xdg-entry-window-management-comment = Super-tast-handling, vindueskontrolindstillinger og yderligere vinduesopdelingsindstillinger
xdg-entry-wired-comment = Kablede forbindelser og forbindelsesprofiler
qr-code-unavailable = QR-kode ikke tilgængelig
network-name = Netværksnavn
auth-dialog = Godkendelse påkrævet
    .vpn-description = Indtast det brugernavn og den adgangskode, som VPN-tjenesten kræver.
...
share = Del netværk
scan-to-connect-description = Scan QR-koden for at oprette forbindelse til dette netværk.
bluetooth-display-passkey = Bluetooth-parring
    .description = Indtast følgende pinkode på { $device }, og tryk derefter på Enter
bluetooth-display-pin = Bluetooth-parring
    .description = Indtast følgende pinkode på { $device }, og tryk derefter på Enter
