...
frosted = Ефект матового скла для системного інтерфейсу
    .desc = Застосовує розмиття тла до панелі, області запуску, аплетів, запускача та бібліотеки застосунків
...
panel-behavior-and-position = Поведінка та положення
    ...
    .dock-autohide = Автоматично приховувати область запуску
    .position = Положення на екрані
    .display = Показувати на дисплеї
panel-style = Стиль
    .anchor-gap = Відступ між панеллю та краями екрана
    .dock-anchor-gap = Відступ між областю запуску та краями екрана
    .extend = Розширити панель до країв екрана
    .dock-extend = Розширити область запуску до країв екрана
    .appearance = Зовнішній вигляд
    .size = Розмір
    .background-opacity = Непрозорість тла
panel-applets = Налаштування
    .dock-desc = Налаштуйте аплети в області запуску
...
dock = Область запуску
    .desc = Необов’язкова область для панелі застосунків і аплетів
...
default-apps = Типові застосунки
    .desc = Типовий переглядач, поштовий клієнт, файловий менеджер та інші застосунки
