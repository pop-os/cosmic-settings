...
xdg-entry-a11y-keywords = COSMIC;无障碍;A11y;屏幕;阅读器;放大镜;高对比;颜色;
xdg-entry-date-time-keywords = COSMIC;时间;区域;
...
xdg-entry-workspaces-keywords = COSMIC;工作区;方向;总预览;显示屏;
...
xdg-entry-input-keywords = COSMIC;输入;键盘;鼠标;鼠标;
...
xdg-entry-displays-keywords = COSMIC;显示器;
