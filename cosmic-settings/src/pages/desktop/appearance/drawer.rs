...
impl Content {
    ...
    pub fn shadow_and_corners(&self) -> Element<'_, crate::pages::Message> {
        ...
        cosmic::iced::widget::column![
            settings::section()
                .add(
                    settings::item::builder(fl!("clip-floating"))
                        .toggler(self.clip_floating, |b| {
                            Message::DrawerCorners(CornerMessage::ClipFloating(b))
                        })
                )
                .add(
                    settings::item::builder(fl!("clip-tiled")).toggler(self.clip_tiled, |b| {
                        Message::DrawerCorners(CornerMessage::ClipTiled(b))
                    })
                )
                .add(
                    settings::item::builder(fl!("shadow-tiled")).toggler(self.shadow_tiled, |b| {
